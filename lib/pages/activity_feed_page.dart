              ...
              child: _isLoading 
                ...
                : ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      Color color;
                      switch(type) {
                        case 'login': icon = Icons.login; color = Colors.blue; break;
                        case 'logout': icon = Icons.logout; color = Colors.orange; break;
                        case 'collect_point': icon = Icons.add_circle; color = Colors.green; break;
                        case 'redeem_reward': icon = Icons.card_giftcard; color = Colors.purple; break;
                        default: icon = Icons.notifications; color = Colors.amber;
                      }
